...
export const signup = createAsyncThunk<signupRequestData, signupRequestData>('member/signup', async (data, { rejectWithValue }) => {
  console.log('=============>', data);
  try {
...
export const emailAuthRequest = createAsyncThunk<emailauthRequestData, emailauthRequestData>('member/emailauth', async (data, { rejectWithValue }) => {
  console.log('=============>', data);
...
export const authnumVerifyRequest = createAsyncThunk<emailauthRequestData, emailauthRequestData>('member/emailauth', async (data, { rejectWithValue }) => {
  console.log('=============>', data);
  try {
