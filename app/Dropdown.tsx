        ...
        <div className={postCardDropdown ? 'flex relative' : 'hidden relative'}>
          ...
          >
            ...
            <div className="sm h-full flex justify-center items-center">
                ...
                <Modal.Body>
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-4">
                      <Button color="failure" onClick={onDeleteArticle}>
                        {deletePostLoading ? <Spinner /> : '삭제하기'}
                      </Button>
                      <Button color="gray" onClick={onDeleteClose}>
                        나가기
                      </Button>
                    </div>
                  </div>
              ...
              {/* 신고하기 Modal */}
              <Modal show={onReportModal} size="md" onClose={onReportModalClose}>
                <Modal.Header>게시글 신고하기</Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                  <Button onClick={onReportModalSubmit} disabled={isReported == true}>
                    신고하기
                  </Button>
                  <Button color="gray" onClick={onReportModalClose}>
                    아니요
                  </Button>
                  {isReported && (
                    <span className="text-red-500">
                      이미 신고한 게시글입니다.<br></br> 잠시후 종료됩니다
                    </span>
                  )}
                </Modal.Footer>
              </Modal>
